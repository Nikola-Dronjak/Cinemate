                            ...
                            <IonCard>
                                ...
                                <IonCardContent>
                                    ...
                                    <form onSubmit={updateUser}>
                                        ...
                                        <IonInput className='ion-margin-top' label={t('inputs.labels.email')} type='text' placeholder='example@gmail.com' labelPlacement='floating' fill='outline' clearInput={true} value={user.email} onIonInput={(e) => setUser({ ...user, email: e.detail.value?.trim() || '' })} />
                                        {validationErrors.email && <span style={{ color: 'red' }}>{validationErrors.email}</span>}
                                        <IonInput className='ion-margin-top' label={t('inputs.labels.password')} type='password' placeholder={t('inputs.placeholders.newPassword')} labelPlacement='floating' fill='outline' clearInput={true} value={user.password} onIonInput={(e) => setUser({ ...user, password: e.detail.value?.trim() || '' })} />
